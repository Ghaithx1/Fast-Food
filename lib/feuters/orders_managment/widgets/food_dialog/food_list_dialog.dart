...
class foodListDialog extends StatelessWidget {
  foodListDialog(this.foods,
      {required this.choseFood, required this.addFood, super.key});
  List<Food> foods;
              ...
              children: [
                Expanded(
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return FoodListDialogItem(
                        foods[index],
                        onPressed: (value) => choseFood(value),
                      );
                    },
                ...
                Row( 
                  children: [
                    ...
                    Expanded(
                        child: TextFormField(
                      decoration: InputDecoration(hintText: "Food Price"),
                    ...
                    nextButton(
                      text: "Add",
                      () {
                        addFood(double.parse(foodPrice.text), foodName.text);
                      },
                      fontSize: 32,
                    ),
                  ],
