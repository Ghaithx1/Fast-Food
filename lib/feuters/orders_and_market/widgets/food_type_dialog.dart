...
class FoodTypeDialog extends StatelessWidget {
  FoodTypeDialog({required this.changeTheType,required this.changeTheBothType, super.key});
  ValueSetter<FoodType> changeTheType;
  ValueSetter2<FoodType, FoodType> changeTheBothType;
  @override
                ...
                children: [
                  Row(
                    ...
                    children: [
                      FoodTypeDialogItem(
                        FoodType.market,
                        onPressed: (value) => changeTheBothType(value,FoodType.coffe),
                      ),
                      FoodTypeDialogItem(
                        FoodType.yali,
                        onPressed: (value) => changeTheType(value),
                      ),
                    ],
                  ),
                  SizedBox(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      FoodTypeDialogItem(
                        FoodType.poca,
                        onPressed: (value) => changeTheBothType(value,FoodType.borek),
                      ),
                    ],
                  ),
                  SizedBox(
